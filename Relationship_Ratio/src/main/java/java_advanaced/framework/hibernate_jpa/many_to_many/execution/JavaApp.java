package java_advanaced.framework.hibernate_jpa.many_to_many.execution;
...
import java_advanaced.framework.hibernate_jpa.many_to_many.entity.Project;
import java_advanaced.framework.hibernate_jpa.many_to_many.entity.Student;
...
Persistence.createEntityManagerFactory("Students_Projects_database");
...
System.out.println("1 Insert Student With Projects");
...
System.out.println("Enter Project "+i+" Details");
